...
#pragma mark - 快速排序
- (void)sortUsingQuickTypeWithArray:(NSMutableArray *)array leftOffset:(NSInteger)left rightOffset:(NSInteger)right {
    if (left < right) {
...
- (void)logArray:(NSArray *)array {
    [array enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) { printf("%d ", [obj intValue]); }];
    printf("\n");
}
@end
