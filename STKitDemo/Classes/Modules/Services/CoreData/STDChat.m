...
+ (CGRect)convertRect:(CGRect)rect0 fromDirection:(STDChatViewDirection)fromDirection toDirection:(STDChatViewDirection)toDirection {
...
+ (CGFloat)heightForMessageWithEntity:(STDMessage *)message identifier:(NSString **)identifier chatViewRect:(CGRect *)chatViewRect {
